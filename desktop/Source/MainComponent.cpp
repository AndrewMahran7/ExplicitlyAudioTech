...
MainComponent::MainComponent()
{
    ...
    // Live lyrics display
    liveLyricsLabel.setText ("Live Lyrics:", juce::dontSendNotification);
    ...
    liveLyricsDisplay.setFont (juce::Font (32.0f, juce::Font::bold));
    liveLyricsDisplay.setJustificationType (juce::Justification::centred);
    liveLyricsDisplay.setColour (juce::Label::backgroundColourId, juce::Colours::black);
    liveLyricsDisplay.setColour (juce::Label::textColourId, juce::Colours::white);
...
void MainComponent::resized()
{
    ...
    // Live lyrics display (large, prominent)
    liveLyricsLabel.setBounds (area.removeFromTop (25));
    liveLyricsDisplay.setBounds (area.removeFromTop (80));
    area.removeFromTop (10);
...
void MainComponent::stopProcessing()
{
    ...
    startStopButton.setButtonText ("Start Processing");
    statusValueLabel.setText ("Idle", juce::dontSendNotification);
    statusValueLabel.setColour (juce::Label::textColourId, getLookAndFeel().findColour (juce::Label::textColourId));
    latencyValueLabel.setText ("-- ms", juce::dontSendNotification);
    levelValueLabel.setText ("0.000", juce::dontSendNotification);
